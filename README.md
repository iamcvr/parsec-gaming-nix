...
``` nix
{
  inputs = 
  {
    parsecgaming.url = "github:iamcvr/parsec-gaming-nix";
  };
}
```
and 
...
```
### in a shell
simply run ```nix shell github:iamcvr/parsec-gaming-nix#parsecgaming``` on a flake-enabled nixos system
...
To do this simply edit the default.nix file - updating the url as appropriate. see [here](https://github.com/iamcvr/parsec-gaming-nix/blob/6610278873cef9371b338788c06cb0b53d860b25/default.nix#L9), and [here](https://github.com/iamcvr/parsec-gaming-nix/blob/6610278873cef9371b338788c06cb0b53d860b25/default.nix#L23);
...
Credit goes to @DarthPJB for the fork, @matthewcroughan for the original nix-file, and @nixinator for helping with repackaging.
